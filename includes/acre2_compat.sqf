...
PROGRAM_CHANNEL("ACRE_PRC152", 6,  "TASKING NET 1", 83.8, 83.8)
PROGRAM_CHANNEL("ACRE_PRC152", 7,  "TASKING NET 2", 84.5, 84.5)
PROGRAM_CHANNEL("ACRE_PRC152", 8,  "TASKING NET 3", 85.2, 85.2)
...
PROGRAM_CHANNEL("ACRE_PRC152", 14, "EMERGENCY NET", 89.4, 89.4)
...
PROGRAM_CHANNEL("ACRE_PRC117F", 6,  "TASKING NET 1", 83.8, 83.8)
PROGRAM_CHANNEL("ACRE_PRC117F", 7,  "TASKING NET 2", 84.5, 84.5)
PROGRAM_CHANNEL("ACRE_PRC117F", 8,  "TASKING NET 3", 85.2, 85.2)
...
PROGRAM_CHANNEL("ACRE_PRC117F", 14, "EMERGENCY NET", 89.4, 89.4)
