...
force ace_medical_deathChance = 0.45;
...
force acre_sys_core_terrainLoss = 0.15;
...
force crowsza_pingbox_CBA_Setting_fade_duration = 15;
force crowsza_pingbox_CBA_Setting_oldLimit = 15;
force crowsza_zeus_text_CBA_Setting_rc_helper = false;
force crowsza_zeus_text_CBA_Setting_rc_helper_color = [1,0,0,1];
