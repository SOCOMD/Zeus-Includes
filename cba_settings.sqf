...
force force ace_common_restedSwayFactor = 0.15;
...
force ace_medical_treatment_treatmentTimeCoeffZeus = 5;
...
force ace_medical_treatment_treatmentTimeTrainedAutoinjector = 1.18566;
force ace_medical_treatment_treatmentTimeTrainedIV = 10;
force ace_medical_treatment_treatmentTimeTrainedSplint = 7;
force ace_medical_treatment_treatmentTimeTrainedTourniquet = 0.3;
...
force force ace_overheating_heatCoef = 0.25;
...
force force acre_sys_core_terrainLoss = 0.15;
force force acre_sys_core_ts3ChannelName = "ACRE:OperationsServer";
force force acre_sys_radio_defaultRadio = "ACRE_BF888S";
...
force force emr_main_animSpeedCoef = 1.24716;
force force emr_main_animSpeedStaminaCoef = 0.197835;
force force emr_main_assistDuty = 1.2;
force force emr_main_assistHeight = 1;
force force emr_main_climbingEnabled = true;
force force emr_main_climbOnDuty = 2.72;
force force emr_main_climbOverDuty = 2.4;
force force emr_main_dropDuty = 0.56;
force force emr_main_enableWeightCheck = false;
force force emr_main_jumpDuty = 0.8;
force force emr_main_jumpForwardVelocity = 1.2;
force force emr_main_jumpingEnabled = true;
force force emr_main_jumpingLoadCoefficient = 0.8;
force force emr_main_jumpVelocity = 3.5;
force force emr_main_maxClimbHeight = 2.6;
force force emr_main_maxDropHeight = 20;
...
force force kat_breathing_deterioratingPneumothorax_chance = 10.2588;
...
force force kat_breathing_SpO2_dieValue = 45;
...
force force kat_breathing_SpO2_unconscious = 80;
...
force force kat_circulation_AED_MaxChance = 60.1;
force force kat_circulation_AED_MinChance = 20.0311;
force force kat_circulation_AED_X_MaxChance = 90;
force force kat_circulation_AED_X_MinChance = 60;
...
force force kat_misc_AFAKFifthSlotItem = "[['kat_larynx', 2]]";
...
force force kat_misc_AFAKSecondSlotItem = "[['ACE_packingBandage', 10], ['ACE_fieldDressing', 10]]";
...
force force kat_misc_IFAKFirstSlotItem = "[['ACE_tourniquet', 3], ['ACE_splint', 2]]";
force force kat_misc_IFAKFourthSlotItem = "[['kat_chestSeal', 2], ['kat_larynx', 1]]";
...
force force kat_misc_MFAKEighthSlotItem = "[['kat_pocketBVM', 1], ['kat_Pulseoximeter', 2], ['kat_X_AED', 1], ['kat_accuvac', 1], ['ACE_surgicalKit', 1]]";
force force kat_misc_MFAKFifthSlotItem = "[['kat_larynx', 8]]";
force force kat_misc_MFAKFirstSlotItem = "[['ACE_tourniquet', 8], ['ACE_splint', 4]]";
force force kat_misc_MFAKFourthSlotItem = "[['kat_chestSeal', 6]]";
force force kat_misc_MFAKSecondSlotItem = "[['ACE_packingBandage', 15], ['ACE_elasticBandage', 15], ['ACE_fieldDressing', 15]]";
force force kat_misc_MFAKSeventhSlotItem = "[['ACE_salineIV_250', 4], ['ACE_salineIV_500', 4], ['ACE_salineIV', 2], ['kat_IO_FAST', 4], ['kat_IV_16', 12]]";
force force kat_misc_MFAKSixthSlotItem = "[['ACE_morphine', 6], ['ACE_epinephrine', 6], ['ACE_adenosine', 6], ['kat_Carbonate', 4], ['kat_naloxone', 4], ['kat_TXA', 4], ['kat_EACA', 4], ['kat_norepinephrine', 4], ['kat_phenylephrine', 4], ['kat_atropine', 2]]";
...
force force kat_pharma_treatmentTime_EACA = 3.99204;
...
// KNB
force force KNB_panel_aceAction = true;
...
// STX Civilians
force force stx_civilians_autoStart = false;
...
force force tsp_cba_breach_ammo_multiplier = 0;
force force tsp_cba_breach_lock_door = 0.152822;
force force tsp_cba_breach_lock_house = 0.152822;
